...
from treemonitoring.models.pastis_models.convlstm import BConvLSTM, ConvLSTM
from treemonitoring.models.pastis_models.ltae import LTAE2d
...
class TemporallySharedBlock(nn.Module):
    ...
    This module adds the self.smart_forward() method the the block. smart_forward will combine the
    batch and temporal dimension of an input tensor if it is 5-D and apply the shared convolutions
    to all the (batch x temp) positions.
    """
...
class RecUNet(nn.Module):
    ...
    Similar to the U-TAE architecture but the L-TAE is replaced by a recurrent network and temporal
    averages are computed for the skip connections.
    """
