...
class ConvGRUCell(nn.Module):
    ...
    def init_hidden(self, batch_size, device):
        return Variable(torch.zeros(batch_size, self.hidden_dim, self.height, self.width)).to(
            device
        )
...
class ConvGRU(nn.Module):
    ...
    def forward(self, input_tensor, hidden_state=None, pad_mask=None, batch_positions=None):
        """
